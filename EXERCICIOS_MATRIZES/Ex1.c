...
/*Crie um vetor de 8 posições contendo números inteiros informados pelo usuário, calcular a média dos valor e informar quantos valores estão acima da média*/
